...
export default function SuperAdminLogin() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // In a real app, we would authenticate the super admin user
    // For this demo, we'll just navigate to the super admin dashboard
    setTimeout(() => {
      setIsLoading(false);
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 mt-1">Access your super admin dashboard</p>
          </div>
